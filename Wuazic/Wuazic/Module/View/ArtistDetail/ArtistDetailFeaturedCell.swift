...
class ArtistDetailFeaturedCell: BaseTableCell {
    ...
    fileprivate let listCollectionView: UICollectionView = {
        ...
        view.registerItem(cell: ArtistDetailFeaturedItemCell.self)
        return view
    }()
...
extension ArtistDetailFeaturedCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: ArtistDetailFeaturedItemCell = collectionView.dequeueReusableCell(indexPath: indexPath)
...
extension ArtistDetailFeaturedCell: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return ArtistDetailFeaturedItemCell.size(height: collectionView.size.height)
    }
}

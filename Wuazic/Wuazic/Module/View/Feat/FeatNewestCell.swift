...
extension FeatNewestCell: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension FeatNewestCell: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return FeatNewestItemCell.size(height: collectionView.size.height)
    }
}

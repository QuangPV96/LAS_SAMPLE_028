...
class ArtistController: BaseController {
    ...
    fileprivate let listCollectionView: UICollectionView = {
        ...
        view.backgroundColor = .clear
        view.registerItem(cell: ArtistItemCell.self)
...
extension ArtistController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == 0 {
            ...
            let cell: ArtistItemCell = collectionView.dequeueReusableCell(indexPath: indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if indexPath.section == 0 {
            ...
            AdsInterstitialHandle.shared.tryToPresent { [unowned self] in
                ...
                detail.artist = data[indexPath.row]
...
extension ArtistController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return ArtistItemCell.size(width: collectionView.size.width - 2 * kPadding)
    }
}
